            ...
            <tbody>
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div>
                      <img src="<?= base_url('assets/admin/assets/img/small-logos/logo-xd.svg') ?>"
                ...
                <td>
                  <div class="avatar-group mt-2">
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      ...
                      <img src="<?= base_url('assets/admin/assets/img/team-1.jpg') ?>" alt="team1">
                    </a>
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Romina Hadid">
                      <img src="<?= base_url('assets/admin/assets/img/team-2.jpg') ?>" alt="team2">
                    </a>
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Alexander Smith">
                      <img src="<?= base_url('assets/admin/assets/img/team-3.jpg') ?>" alt="team3">
                    </a>
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Jessica Doe">
                      <img src="<?= base_url('assets/admin/assets/img/team-4.jpg') ?>" alt="team4">
                    </a>
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div>
                      <img src="<?= base_url('assets/admin/assets/img/small-logos/logo-atlassian.svg') ?>"
                ...
                <td>
                  <div class="avatar-group mt-2">
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Romina Hadid">
                      <img src="<?= base_url('assets/admin/assets/img/team-2.jpg') ?>" alt="team5">
                    </a>
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Jessica Doe">
                      <img src="<?= base_url('assets/admin/assets/img/team-4.jpg') ?>" alt="team6">
                    </a>
                  </div>
                </td>
                <td class="align-middle text-center text-sm">
              ...
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div>
                      <img
                        src="<?= base_url('assets/admin/assets/img/small-logos/logo-slack.svg" class="avatar avatar-sm me-3') ?>"
                        alt="team7">
                    </div>
                    <div class="d-flex flex-column justify-content-center">
                ...
                <td>
                  <div class="avatar-group mt-2">
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Romina Hadid">
                      <img src="<?= base_url('assets/admin/assets/img/team-3.jpg') ?>" alt="team8">
                    </a>
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Jessica Doe">
                      <img src="<?= base_url('assets/admin/assets/img/team-1.jpg') ?>" alt="team9">
                    </a>
                  </div>
                </td>
                <td class="align-middle text-center text-sm">
              ...
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div>
                      <img src="<?= base_url('assets/admin/assets/img/small-logos/logo-spotify.svg') ?>"
                ...
                <td>
                  <div class="avatar-group mt-2">
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Ryan Tompson">
                      <img src="<?= base_url('assets/admin/assets/img/team-4.jpg') ?>" alt="user1">
                    </a>
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Romina Hadid">
                      <img src="<?= base_url('assets/admin/assets/img/team-3.jpg') ?>" alt="user2">
                    </a>
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Alexander Smith">
                      <img src="<?= base_url('assets/admin/assets/img/team-4.jpg') ?>" alt="user3">
                    </a>
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Jessica Doe">
                      <img src="<?= base_url('assets/admin/assets/img/team-1.jpg') ?>" alt="user4">
                    </a>
                  </div>
                </td>
                <td class="align-middle text-center text-sm">
              ...
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div>
                      <img src="<?= base_url('assets/admin/assets/img/small-logos/logo-jira.svg') ?>"
                ...
                <td>
                  <div class="avatar-group mt-2">
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Ryan Tompson">
                      <img src="<?= base_url('assets/admin/assets/img/team-4.jpg') ?>" alt="user5">
                    </a>
                  </div>
                </td>
                <td class="align-middle text-center text-sm">
              ...
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div>
                      <img src="<?= base_url('assets/admin/assets/img/small-logos/logo-invision.svg') ?>"
                ...
                <td>
                  <div class="avatar-group mt-2">
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Ryan Tompson">
                      <img src="<?= base_url('assets/admin/assets/img/team-1.jpg') ?>" alt="user6">
                    </a>
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" title="Jessica Doe">
                      <img src="<?= base_url('assets/admin/assets/img/team-4.jpg') ?>" alt="user7">
                    </a>
                  </div>
                </td>
                <td class="align-middle text-center text-sm">
