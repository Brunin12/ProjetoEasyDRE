<?php $ID = $this->session_m->get_id();
$empresa = $this->empresa->get_empresa_id($this->session_m->userdata('empresa')['id_empresa']);
?>

<?php if ((!is_null($ID)) && ($this->auth->existe_dre())):
  $margem_lucro =
              ...
              <div class="numbers">
                ...
                <h5 class="font-weight-bolder mb-0">
                  <span class="text-success">R$
                    <?= number_format($empresa->receita, 2, ',', '.') ?>
                  </span>

                </h5>
                <p class="text-info text-sm font-weight-bolder">(ROI):
                  <?= number_format($roi, 2, ',', '.') ?> (%)
                    </p>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Lucro Liquido</p>
                    <h5 class="font-weight-bolder mb-0">
                      <span class="text-success">R$
                    <?= number_format($empresa->lucro_liquido, 2, ',', '.') ?>
                  </span>
                </h5>
                <p class="text-info text-sm font-weight-bolder">Margem de lucro:
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Despesas</p>
                <h5 class="font-weight-bolder mb-0">
                  <span class="text-danger">R$
                    <?= number_format($empresa->despesa, 2, ',', '.') ?>
                  </span>
